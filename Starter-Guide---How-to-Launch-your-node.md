...
# Download JAR
Download the executable file [alephium-0.11.0.jar](https://github.com/alephium/alephium/releases/download/v0.11.0/alephium-0.11.0.jar) (once it is downloaded, do not double click on it, it can not be launched this way).
Move the **alephium-0.11.0.jar** file in the **.alephium** folder.
...
3. Type the command `java -jar -Xmx500m alephium-0.11.0.jar` in the terminal and press Enter.
