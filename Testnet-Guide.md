...
Currently running **v0.10.2** ([download](https://github.com/alephium/alephium/releases/download/v0.10.2/alephium-0.10.2.jar))
...
You are now ready to start your node using the JAR you downloaded earlier.
    ...
    java -jar -Xmx500m alephium-0.10.2.jar
